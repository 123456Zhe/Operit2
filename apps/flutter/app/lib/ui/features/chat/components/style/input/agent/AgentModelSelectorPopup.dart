          ...
          child: FutureBuilder<_AgentModelSelectorData>(
            ...
            builder: (context, snapshot) {
              ...
              final stops = <String>[
                '关',
                if (levels)
                  ...data.thinkingSettings.options.map(
                    (option) => option.label,
                  )
                else
                  '开',
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    AgentThinkingSliderRow(
                      stops: stops,
                      stop:
                          _thinkingStop ?? _resolveThinkingStop(data, levels),
                      minStop: data.thinkingSettings.requiredValue ? 1 : 0,
                      onChanged: (stop) =>
                          _setThinkingStop(data, levels, stop),
                    ),
                    _ModelSelectorItem(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return GestureDetector(
                    ...
                    onHorizontalDragUpdate: (details) => _applyPosition(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  if (hasMultipleModels) ...<Widget>[
                    ...
                    Flexible(
                      child: Text(
                        models.isEmpty ? provider.providerTypeId : models.first.id,
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: textTheme.labelSmall!.copyWith(
                          color: colorScheme.onSurfaceVariant,
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: ConstrainedBox(
        ...
        child: Row(
          children: <Widget>[
            Text('模型', style: textTheme.labelSmall!.copyWith(
              color: colorScheme.onSurfaceVariant,
            )),
            const SizedBox(width: 6),
            Expanded(
              child: Row(
                children: <Widget>[
                  ...
                  const SizedBox(width: 4),
                  Text('·', style: textTheme.labelSmall!.copyWith(
                    color: colorScheme.onSurfaceVariant,
                  )),
                  const SizedBox(width: 4),
                  Flexible(
